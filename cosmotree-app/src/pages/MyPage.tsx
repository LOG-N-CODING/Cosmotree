                ...
                <div className="flex items-center gap-1">
                  <div className="w-[40px] h-[40px] p-2 flex items-center justify-center">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm4.24 16L12 15.45 7.77 18l1.12-4.81-3.73-3.23 4.92-.42L12 5l1.92 4.53 4.92.42-3.73 3.23L16.23 18z" fill="black"/>
                    </svg>
                  </div>
                  <span className="text-[16px] md:text-[18px] text-black leading-[1.5]">Profile Information</span>
                </div>
            ...
            <div className="flex flex-col gap-4 items-center">
              <div className="w-full max-w-[408px]">
                <div className="bg-white rounded-lg px-4 py-2 w-full h-[56px] flex items-center gap-3">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M12 2C13.1 2 14 2.9 14 4C14 5.1 13.1 6 12 6C10.9 6 10 5.1 10 4C10 2.9 10.9 2 12 2ZM21 9V7L15 5.5V4H9V5.5L3 7V9H21ZM12 8C10.9 8 10 8.9 10 10V11H14V10C14 8.9 13.1 8 12 8ZM2 20V18H22V20H2Z" fill="black"/>
                  </svg>
                  <span className="text-[18px] md:text-[20px] font-bold text-black">Star Lee</span>
                </div>
              </div>
              ...
              <div className="w-full max-w-[408px]">
                <div className="bg-white rounded-lg px-4 py-2 w-full h-[56px] flex items-center gap-3">
                  ...
                  <span className="text-[18px] md:text-[20px] text-black">user@cosmotree.com</span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-[20px] md:gap-[32px]">
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                  <div className="flex items-center gap-1">
                    <div className="w-[40px] h-[40px] p-2 flex items-center justify-center">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm4.24 16L12 15.45 7.77 18l1.12-4.81-3.73-3.23 4.92-.42L12 5l1.92 4.53 4.92.42-3.73 3.23L16.23 18z" fill="#1C1B1F"/>
                      </svg>
                    </div>
                    <span className="text-[16px] md:text-[18px] text-black leading-[1.5]">Profile Information</span>
                  </div>
              ...
              <div className="flex flex-col gap-4 items-center">
                <div className="w-full max-w-[408px]">
                  <div className="bg-white border border-[#CCCCCC] rounded-lg px-4 py-2 w-full h-[56px] flex items-center gap-3">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M12 2C13.1 2 14 2.9 14 4C14 5.1 13.1 6 12 6C10.9 6 10 5.1 10 4C10 2.9 10.9 2 12 2ZM21 9V7L15 5.5V4H9V5.5L3 7V9H21ZM12 8C10.9 8 10 8.9 10 10V11H14V10C14 8.9 13.1 8 12 8ZM2 20V18H22V20H2Z" fill="#1C1B1F"/>
                    </svg>
                    <input 
                      type="text"
                ...
                <div className="w-full max-w-[408px]">
                  <div className="bg-white border border-[#CCCCCC] rounded-lg px-4 py-2 w-full h-[56px] flex items-center gap-3">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M20 4H4C2.9 4 2.01 4.9 2.01 6L2 18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V6C22 4.9 21.1 4 20 4ZM20 8L12 13L4 8V6L12 11L20 6V8Z" fill="#1C1B1F"/>
                    </svg>
                    <input 
                      type="email"
                ...
                <div className="w-full max-w-[408px]">
                  <div className="bg-white border border-[#CCCCCC] rounded-lg px-4 py-2 w-full h-[56px] flex items-center gap-3">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M18 8H17V6C17 3.24 14.76 1 12 1S7 3.24 7 6V8H6C4.9 8 4 8.9 4 10V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V10C20 8.9 19.1 8 18 8ZM12 19C10.9 19 10 18.1 10 17S10.9 15 12 15S14 15.9 14 17S13.1 19 12 19ZM15.1 8H8.9V6C8.9 4.29 10.29 2.9 12 2.9S15.1 4.29 15.1 6V8Z" fill="#1C1B1F"/>
                    </svg>
                    <input 
                      type="password"
                      ...
                      <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-[19px] w-full lg:w-auto">
                        <div className="w-full md:w-[212px] h-[80px] md:h-[98px] bg-[#EEEEEE] border-b border-[#E4E4E4] rounded-[12px] flex items-center justify-center p-4 md:p-6">
                          <div className="text-center">
                            <div className="text-[18px] md:text-[20px] font-bold text-black mb-1">{module.title}</div>
                            <div className="text-[12px] md:text-[14px] text-black">{module.description}</div>
                          </div>
                        </div>
                        <div className="flex flex-col gap-2">
                          <div className="text-[18px] md:text-[20px] font-bold text-black">{module.title}</div>
                          <div className="text-[12px] md:text-[14px] text-black">{module.description}</div>
                        </div>
                      </div>
              ...
              <div className="min-w-[800px] flex gap-[-8px]">
                ...
                <div className="w-[300px] md:w-[484px]">
                  ...
                  {quizHistoryData.map((quiz) => (
                    <div key={quiz.id} className="border-b border-[#CCCCCC] p-3 md:p-6 h-[48px] md:h-[56px] flex items-center">
                      <span className="text-[14px] md:text-[16px] text-black truncate">{quiz.topic}</span>
                    </div>
                  ))}
                </div>
                ...
                <div className="w-[100px] md:w-[124px]">
                  ...
                  {quizHistoryData.map((quiz) => (
                    <div key={quiz.id} className="border-b border-[#CCCCCC] p-3 md:p-6 h-[48px] md:h-[56px] flex items-center justify-center">
                      <div className="bg-[#EEEEEE] border border-[#BDBDBD] rounded px-2 py-1">
                        <span className="text-[12px] md:text-[14px] font-semibold text-black">{quiz.module}</span>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="w-[100px] md:w-[137px]">
                  <div className="border-b border-black p-3 md:p-6 text-center">
                    <h3 className="text-[14px] md:text-[16px] font-semibold text-black">Difficulty</h3>
                  </div>
                  {quizHistoryData.map((quiz) => (
                    <div key={quiz.id} className="border-b border-[#CCCCCC] p-3 md:p-6 h-[48px] md:h-[56px] flex items-center justify-center">
                      <div className={`rounded px-2 py-1 ${
                        ...
                        <span className="text-[12px] md:text-[14px] font-semibold text-black">{quiz.difficulty}</span>
                      </div>
                    </div>
                  ))}
                </div>
                        ...
                        {quiz.status === 'complete' ? (
                          <>
                            <svg width="16" height="16" viewBox="0 0 20 20" fill="none" className="md:w-5 md:h-5">
                              <path d="M10 1.67C5.4 1.67 1.67 5.4 1.67 10C1.67 14.6 5.4 18.33 10 18.33C14.6 18.33 18.33 14.6 18.33 10C18.33 5.4 14.6 1.67 10 1.67ZM8.33 14.17L4.17 10L5.34 8.83L8.33 11.82L14.66 5.49L15.83 6.66L8.33 14.17Z" fill="#00A336"/>
                            </svg>
                            <span className="text-[12px] md:text-[14px] text-[#00A336] hidden md:inline">Complete</span>
                          </>
                        ) : (
                          <>
                            <svg width="16" height="16" viewBox="0 0 20 20" fill="none" className="md:w-5 md:h-5">
                              <circle cx="10" cy="10" r="8.33" stroke="#D9D9D9" strokeWidth="1.67" fill="none"/>
                            </svg>
                            <span className="text-[12px] md:text-[14px] text-[#D9D9D9] hidden md:inline">Pending</span>
                          </>
                        )}
                      </div>
                    </div>
                    ...
                    <div key={quiz.id} className="border-b border-[#CCCCCC] p-3 md:p-6 h-[48px] md:h-[56px] flex items-center justify-center">
                      ...
                      >
                        {quiz.action === 'retake' ? (
                          <>
                            <svg width="16" height="16" viewBox="0 0 20 20" fill="none" className="md:w-5 md:h-5">
                              <path d="M14.17 2.5L12.92 3.75L15.42 6.25H10C6.55 6.25 3.75 9.05 3.75 12.5C3.75 15.95 6.55 18.75 10 18.75C13.45 18.75 16.25 15.95 16.25 12.5H14.58C14.58 15.03 12.53 17.08 10 17.08C7.47 17.08 5.42 15.03 5.42 12.5C5.42 9.97 7.47 7.92 10 7.92H15.42L12.92 10.42L14.17 11.67L18.33 7.5L14.17 2.5Z" fill="white"/>
                            </svg>
                            <span className="text-[12px] md:text-[14px] hidden md:inline">Retake</span>
                          </>
                        ) : (
                          <>
                            <svg width="16" height="16" viewBox="0 0 20 20" fill="none" className="md:w-5 md:h-5">
                            ...
                            <span className="text-[12px] md:text-[14px] hidden md:inline">Start</span>
                          </>
                        )}
                      </button>
                    </div>
